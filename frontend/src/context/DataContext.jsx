...
export const DataProvider = ({ children }) => {
    const [services, setServices] = useState([
        { id: 1, name: 'accounting', icon: '', description: 'Fix leaks, install pipes, and more.', image: '' },
        { id: 2, name: 'civil engineer', icon: '', description: 'Wiring, repairs, and installations.', image: 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=400' },
        { id: 3, name: 'teacher ', icon: '', description: 'Home and office cleaning services.', image: 'https://images.unsplash.com/photo-1581578731117-104f2a41272c?auto=format&fit=crop&q=80&w=400' }, // Placeholder
        { id: 4, name: 'devloper', icon: '', description: 'Help with relocating to a new place.', image: 'https://images.unsplash.com/photo-1600585152220-90363fe7e115?auto=format&fit=crop&q=80&w=400' },
        { id: 5, name: 'database admin', icon: '', description: 'Interior and exterior painting.', image: 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&q=80&w=400' },
        { id: 6, name: ' ', icon: '', description: 'Lawn care and landscaping.', image: 'https://images.unsplash.com/photo-1615811361524-6830df58bca6?auto=format&fit=crop&q=80&w=400' },
    ]);
    ...
    const [providers, setProviders] = useState([
        ...
        { id: 3, name: 'Ali mowlid abdillahi ', service: 'senior accounting ', rating: 4.7, reviews: 200, location: 'soomaliland, HR', price: '40/hr', image: ALI, description: 'Professional manageging finance and offices.' },
